...
SHOTS = [
    ...
    ("07_popup_auto_tasbih.png", "نافذة التسبيح التلقائي", "Auto tasbih popup over other apps"),
    ("08_popup_auto_azkar.png", "الأذكار التلقائية", "Auto adhkar on your schedule"),
