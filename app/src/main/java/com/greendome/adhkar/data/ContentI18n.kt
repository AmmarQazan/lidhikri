...
object ContentI18n {
    ...
    fun azkarMeaning(textAr: String, lang: String): String? {
        ...
        return when {
            ...
            "لا مانع لما اعطيت" in n -> AFTER_PRAYER_LA_MANI[lang]
            "كره الكافرون" in n || ("لا نعبد الا اياه" in n && "الثناء الحسن" in n) -> AFTER_PRAYER_LA_NAABUDU[lang]
            "يحيي ويميت" in n && "وحده لا شريك" in n -> AFTER_PRAYER_TAHLIL_TEN[lang]
            "اعني علي ذكرك" in n -> AFTER_PRAYER_AINNI[lang]
            "اعوذ بك من البخل" in n && "ارذل العمر" in n -> AFTER_PRAYER_BUKHL[lang]
    ...
    fun virtue(virtueAr: String, lang: String): String? {
        ...
        return when {
            ...
            "بعد السلام ثلاثا" in n -> VIRTUE_AFTER_ISTIGHFAR[lang]
            "بعد الاستغفار" in n -> VIRTUE_AFTER_SALAM[lang]
            "تمام المائه" in n -> VIRTUE_AFTER_TAHLIL_HUNDRED[lang]
            "بعد المغرب والفجر" in n -> VIRTUE_AFTER_MAGHRIB_FAJR[lang]
            "رواه البخاري ومسلم" in n -> VIRTUE_AFTER_LA_MANI[lang]
            "بعد كل فريضه" in n -> VIRTUE_AFTER_LA_NAABUDU[lang]
            "رواه ابو داود واحمد" in n -> VIRTUE_AFTER_AINNI[lang]
            "بعد كل صلاه" in n && "رواه البخاري" in n -> VIRTUE_AFTER_BUKHL[lang]
            "دبر كل صلاه" in n && "رواه مسلم" in n -> VIRTUE_AFTER_TASBIH[lang]
