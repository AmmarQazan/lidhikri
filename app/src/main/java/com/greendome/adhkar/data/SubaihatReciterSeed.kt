...
object SubaihatReciterSeed {
    ...
    private fun azkarMaps(): List<AzkarSpec> = listOf(
        ...
        AzkarSpec("after_prayer", "after_prayer/la_mani.mp3", listOf("لا مانع")),
        AzkarSpec("after_prayer", "after_prayer/mukhlisin.mp3", listOf("كره الكافرون")),
        AzkarSpec("after_prayer", "after_prayer/bukhl.mp3", listOf("البخل")),
        AzkarSpec("after_prayer", "after_prayer/ainni.mp3", listOf("اعني على ذكرك")),
        AzkarSpec("friday", "tasbih/salawat.mp3", listOf("بارك", "نبينا")),
        AzkarSpec("friday", "friday/hour.mp3", listOf("ساعة لا يوافقها")),
        AzkarSpec("friday", "friday/kahf.mp3", listOf("سورة الكهف")),
